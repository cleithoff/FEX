<?php
class ZFExt_Fex_View_Helper_Navigation extends Zend_View_Helper_Navigation {
	 ...
	 * @var string
	 */
	const NS = 'ZFExt_Fex_View_Helper_Navigation';
	const NS2 = 'Zend_View_Helper_Navigation';
	/**
	...
	public function findHelper($proxy, $strict = true)
	{
		...
		if ($strict) {
			...
			try {
				...
				return null; //parent::findhelper($proxy, $strict);
			}
		}
